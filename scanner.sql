...
CREATE TABLE `port_table` (
  ...
  `httptitle` longtext,
  `cmstype` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `vulns` (
  ...
  `url` longtext,
  `parameters` longtext,
  `headers_string` longtext,
  `method` varchar(15) DEFAULT NULL,
  `delta_time` varchar(50) DEFAULT NULL,
  `vuln_name` varchar(150) DEFAULT NULL,
  `severity` varchar(30) DEFAULT NULL,
  `checks` varchar(150) DEFAULT NULL,
  `proof` longtext,
  `seed` longtext,
  `id_domain` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2018-02-27 18:37:03
